document.addEventListener('DOMContentLoaded', function() {
    ...
    const portfolioData = {
        about: [
            ...
            "> CODENAME: <span class='text-cyan-300'>MuTuA</span>",
            "> CLEARANCE: <span class='text-green-400'>LEVEL 5</span>",
            "> SPECIALIZATION: <span class='text-yellow-300'> FULL_STACK_DEV| BACKEND_ENGINEER | SOFTWARE_DEV</span>",
            "> LOCATION: ████████, ████████",
            "",
            "[BIO]:",
        ...
        skills: [
            ...
            "   - Pandas [█████]",
            "",
            ">> <span class='text-green-400'>DATABASES:</span>",
            "   - PostgreSQL [████████]",
            "   - MongoDB [███████]",
            "   - MySQL [█████]",
            "",
        ...
        projects: [
            ...
            "",
            "1. <span class='text-yellow-300'>CHATBOT (Kazibot Chat System) </span> [CLASSIFIED]",
            "   - Built with: Angular, Node js -Typescript, Socket.IO",
            "   - Status: <span class='text-green-400'>ACTIVE</span>",
            "   - Clearance required: <span class='text-red-400'>LEVEL 4+</span>",
            "",
            "2. <span class='text-yellow-300'>Lecture Alert System</span> [REDACTED]",
            "   - Built with: Django, Celery, Redis",
            "   - Status: <span class='text-green-400'>ACTIVE</span>",
            "   - Clearance required: <span class='text-red-400'>LEVEL 5+</span>",
            "",
            "3. <span class='text-yellow-300'>Data Visualization/span> [EXPUNGED]",
            "   - Built with: Poer BI, Tableau, Pandas",
        ...
        contact: [
            ...
            "   - Keybase: <span class='text-cyan-300'> MUTUA</span>",
            ...
            "   - Email: musyokivincent07@gmail.com",
            "   - GitHub: https://github.com/vinmutua",
            "   - LinkedIn: linkedin.com/in/vincent-musyoki-9aa088243",
            "",
